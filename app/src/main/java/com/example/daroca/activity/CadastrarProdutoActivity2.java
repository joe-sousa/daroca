    ...
    public class CadastrarProdutoActivity2 extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            textViewProgressBar = findViewById(R.id.textProgress);
                    ...
                    if(imagem != null){
                        ...
                        uploadTask.addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Log.e("UploadFalha", errorMessage, e);
                                Toast.makeText(CadastrarProdutoActivity2.this, errorMessage, Toast.LENGTH_SHORT).show();
                            }
                        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            @Override
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                progressBar.setProgress(0);
                                textViewProgressBar.setText("Carregado 100%");
                                Toast.makeText(CadastrarProdutoActivity2.this,
